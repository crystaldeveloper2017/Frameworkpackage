...
<section class="content">
    ...
    <div class="row">
		...
		<div class="col-lg-3 col-6" onclick="window.location='?a=showGSDashboard'">
            <!-- small box -->
            <div class="small-box bg-info">
              <div class="inner">
                <h3>${InVisitorsCount}</h3>
              ...
              <a href="#"  onclick="window.location='?a=showGSDashboard'" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
          ...
          <!-- ./col -->
          <div class="col-lg-3 col-6" onclick="window.location='?a=showDocumentMaster&PermanentFlag=1'">
            <!-- small box -->
            <div class="small-box bg-success">
              <div class="inner">
                <h3>${inPermanenet}</h3>
              ...
              <a href="#"  onclick="window.location='?a=showDocumentMaster&PermanentFlag=1'" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
