...
docReady(function() {
	...
	function onScanSuccess(decodedText, decodedResult) {
 	...
 	var xhttp = new XMLHttpRequest();
 	  xhttp.onreadystatechange = function() 
 	  {
 	    ...
 	    { 	      
 	    	if(xhttp.responseText.includes('alreadyCaptured'))
              ...
              if(resposneTextReceived[0].includes("No Approved Gate Pass Exists for this employee"))
              {
                alert("No Approved Gate Pass Exists for this employee");
 	  ...
 	  xhttp.open("GET","?a=checkInGatePass&qr_code="+decodedText, true);    
 	  xhttp.send();
