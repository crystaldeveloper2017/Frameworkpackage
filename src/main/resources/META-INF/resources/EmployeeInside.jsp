              ...
              <div class="card-body table-responsive p-0" style="height: 800px;">                
				...
				<c:forEach items="${message}" var="item">
					<tr >
						...
						<td>${item.qr_code}</td>
						<td>${item.type}</td><td><a href="?a=showAddEmployee&employeeId=${item.user_id}">Edit</a></td><td><button class="btn btn-danger" onclick="deleteEmployee(${item.user_id})">Delete</button></td>
					</tr>
				</c:forEach>
...
<script>
  ...
  document.getElementById("divTitle").innerHTML=" Employee Inside";
    document.title +=" Employee Inside ";
