...
<form id="frm" action="?a=addVendorCheckIn" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
...
<div class="row">
  <div class="col-sm-12">
      ...
      <input type="text" class="form-control" readonly id="vendorname" value="${vendorDetails.vendor_name}" name="vendorname" >
      <input type="text" class="form-control" readonly id="vendor_qr_code" value="${vendorDetails.qr_code}" name="vendor_qr_code" >
  ...
  <div class="col-sm-12">
      ...
      <input type="text" class="form-control" readonly id="address" value="${vendorDetails.address}" name="address" placeholder="Address">
    </div>
  </div>
   ...
   <div class="col-sm-12">
      ...
      <input type="text" class="form-control" id="remarks" value="${vendorDetails.remarks}" name="remarks" placeholder="Remarks">
    </div>
  </div>
  ...
  <div class="col-sm-12">
      ...
      <input type="text" class="form-control" id="MobileNo" value="${vendorDetails.contact_no1}"  readonly name="MobileNo" placeholder="Mobile No" onkeypress="digitsOnly(event)" maxlength="10" required>
    </div>
  </div>
  ...
  <div class="col-sm-12">
      ...
      <input type="text" class="form-control" id="EmailId" value="${vendorDetails.email}" readonly name="EmailId" placeholder="Email Id">
    </div>
  </div>
...
<c:if test="${visitorDetails.visitor_id eq null}">
	document.getElementById("divTitle").innerHTML="Add Vendor CheckIn";
	document.title +=" Add Vendor CheckIn";
</c:if>
